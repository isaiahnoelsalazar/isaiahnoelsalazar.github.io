class ECModal {
    constructor({title="Modal", content="Content", buttonAmount=1, buttonLabels=[], modalCurveAmount=12, modalButtonsCurveAmount=8, backgroundColor="white", color="black", darkMode=false} = {}) {
        ...
        <div class="ecmodal-content opacity-1 animationName-[ecmodal-bounce] animationDuration-0.2s ${darkMode ? "backgroundColor-#0f0f0f color-white" : `backgroundColor-[${backgroundColor}] color-[${color}]`} minWidth-300px padding-16px borderRadius-${modalCurveAmount}px position-relative eclistv">
