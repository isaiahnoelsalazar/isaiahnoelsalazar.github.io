class ECModal {
    constructor({title="Modal", content="Content", buttonAmount=1, buttonLabels=[], backgroundColor="white", color="black", darkMode=false} = {}) {
        ...
        <div class="ecmodal-content ${darkMode ? "backgroundColor-#0f0f0f color-white" : `backgroundColor-[${backgroundColor}] color-[${color}]`} minWidth-300px padding-16px borderRadius-12px position-relative eclistv">
